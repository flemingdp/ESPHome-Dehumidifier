...
class TestMideaDehum : public esphome::midea_dehum::MideaDehumComponent {
 public:
  ...
  void seed_feature_flags(uint8_t flags) { this->feature_flags_ = flags; }
#ifdef MIDEA_PROTOCOL_V3
  void seed_v3_sequence(uint8_t sequence) { this->v3_transaction_sequence_ = sequence; }
  bool v3_command_pending() const { return this->v3_command_pending_; }
  void clear_v3_pending() { this->v3_command_pending_ = false; }
#endif
...
// Regression state matching the confirmed V3 offsets: Smart, Low, target 60%.
// Direct-injection tests do not validate the trailing CRC/checksum.
static const uint8_t MAD50P1AWS_STATUS_SMART_LOW_TARGET_60[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x05,
    0xA0, 0x01, 0x03, 0x28, 0x7F, 0x7F, 0x00, 0x3C, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x58, 0x00, 0x00,
    0x00, 0x00, 0x22, 0x00, 0x00};
static const uint8_t MAD50P1AWS_STATUS_LOW_TARGET_75_FLAGS_18[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x05,
    0xA0, 0x01, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x4B, 0x00, 0x18,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39, 0x58, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x0D, 0x6C};

// Successful factory SK105 power-ON transaction. LINE A is SK105 -> appliance;
// LINE B is appliance -> SK105. Sequence 0x09 is echoed by the response.
static const uint8_t MAD50P1AWS_FACTORY_POWER_ON[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x43, 0x01, 0xA8, 0x7F, 0x7F, 0x00, 0x37, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x09, 0x6A, 0x60};
static const uint8_t MAD50P1AWS_FACTORY_POWER_ON_RESPONSE[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x02,
    0xC8, 0x01, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x37, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x56, 0x00, 0x00,
    0x00, 0x00, 0x09, 0x3A, 0x28};
static const uint8_t MAD50P1AWS_FACTORY_TARGET_60[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x43, 0x01, 0xA8, 0x7F, 0x7F, 0x00, 0x3C, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x0C, 0xA8, 0x1A};
static const uint8_t MAD50P1AWS_FACTORY_TARGET_60_RESPONSE[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x02,
    0xC8, 0x01, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x3C, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x56, 0x00, 0x00,
    0x00, 0x00, 0x0C, 0x8C, 0xCE};
static const uint8_t MAD50P1AWS_FACTORY_TARGET_55[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x43, 0x01, 0xA8, 0x7F, 0x7F, 0x00, 0x37, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x5F, 0x6C, 0x08};
static const uint8_t MAD50P1AWS_FACTORY_TARGET_55_RESPONSE[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x02,
    0xC8, 0x01, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x37, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x56, 0x00, 0x00,
    0x00, 0x00, 0x5F, 0x3C, 0xD0};
static const uint8_t MAD50P1AWS_FACTORY_POWER_OFF[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x42, 0x01, 0xA8, 0x7F, 0x7F, 0x00, 0x37, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x09, 0x80, 0x4B};
static const uint8_t MAD50P1AWS_FACTORY_POWER_OFF_RESPONSE[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x02,
    0xC8, 0x00, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x37, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x56, 0x00, 0x00,
    0x00, 0x00, 0x09, 0xAD, 0xB6};
static const uint8_t MAD50P1AWS_EXPECTED_POWER_OFF_HIGH_TARGET_50_SEQ_01[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x42, 0x01, 0xD0, 0x7F, 0x7F, 0x00, 0x32, 0x00, 0x18,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x01, 0x5A, 0x3E};
static const uint8_t MAD50P1AWS_EXPECTED_POWER_ON_HIGH_TARGET_50_SEQ_03[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x43, 0x01, 0xD0, 0x7F, 0x7F, 0x00, 0x32, 0x00, 0x18,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x03, 0x0C, 0x89};
static const uint8_t MAD50P1AWS_FACTORY_PUMP_ON[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x43, 0x01, 0xA8, 0x7F, 0x7F, 0x00, 0x23, 0x00, 0x18,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x03, 0x21, 0xAB};
static const uint8_t MAD50P1AWS_FACTORY_PUMP_ON_RESPONSE[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x02,
    0xC8, 0x01, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x23, 0x00, 0x18,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2F, 0x58, 0x00, 0x00,
    0x00, 0x00, 0x03, 0x4E, 0x35};
static const uint8_t MAD50P1AWS_FACTORY_PUMP_OFF[] = {
    0xAA, 0x21, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
    0x48, 0x43, 0x01, 0xA8, 0x7F, 0x7F, 0x00, 0x23, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x3E, 0x27, 0x72};
static const uint8_t MAD50P1AWS_FACTORY_PUMP_OFF_RESPONSE[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x02,
    0xC8, 0x01, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x23, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2F, 0x58, 0x00, 0x00,
    0x00, 0x00, 0x3E, 0x74, 0xDC};
static const uint8_t MAD50P1AWS_FACTORY_QUERY_SEQ_54[] = {
    0xAA, 0x20, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03,
    0x41, 0x81, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x54, 0x4F, 0xD8};

// Pre-command state reconstructed from the successful response, with power
// clear and seed-status discriminator. CRC/checksum are not consulted by the
// direct-injection test path.
static const uint8_t MAD50P1AWS_BEFORE_POWER_ON[] = {
    0xAA, 0x22, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x05,
    0xA0, 0x00, 0x01, 0x28, 0x7F, 0x7F, 0x00, 0x37, 0x00, 0x10,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x56, 0x00, 0x00,
